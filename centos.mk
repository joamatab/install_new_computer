...
vnc:
	...
	sudo cp software/vnc/vncserver@:1.service.centos vncserver@:1.service 
	sudo cp software/vnc/vncserver@:1.service /etc/systemd/system/vncserver@:1.service
	vncserver
	sudo systemctl daemon-reload
	sudo systemctl start vncserver@:1.service
	sudo systemctl enable vncserver@:1.service
	mkdir -p $(HOME)/.vnc
	cp software/vnc/xstartup_xfce $(HOME)/.vnc/xstartup
	sudo systemctl daemon-reload
